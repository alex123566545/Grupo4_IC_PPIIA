...
from src.training.evaluate_groupkfold_random_search import evaluar_groupkfold_hiperparametros_fijos
...
def main():
    ...
    # ====================================
    # Validación honesta: GroupKFold por lote
    # (confirma si este resultado se sostiene con un lote nunca visto)
    # ====================================
